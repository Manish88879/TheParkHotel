...
class CheckBalance extends StatefulWidget {
  ...
  @override
  State<CheckBalance> createState() => _CheckBalance();
}

class _CheckBalance extends State<CheckBalance> {
  ...
  void checkBalance() async {
    if (_cardNumber.text == '') {
      ...
      var url =
          'https://phylopos.in/Theparkhotel/posAPI/getCardBalance.php?cardnumber=${_cardNumber.text}';
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
                ...
                child: Image.network(
                    'https://phylopos.in/Theparkhotel/app2/assets/hotel.jpg',
                    height: 100)),
            SizedBox(height: 20),
            TextField(
            ...
            SizedBox(height: 50),
            Text('Available Balance  =  Rs. ${balance}',
                style: TextStyle(
                    color: Colors.white,
